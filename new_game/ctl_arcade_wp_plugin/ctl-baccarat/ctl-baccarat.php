<?php
    /*
    Plugin Name: CTL Arcade - Baccarat
    Plugin URI: http://www.codethislab.com/
    Description: Baccarat for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeBaccarat{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-baccarat";
        private $_szPluginName              = "Baccarat";
        private $_szAspectRatio             = "9:4";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "3d game, baccarat, baccarat table, card, cards, casino, casino game, baccara, gambling, html5 gambling, html5 baccarat, html5 casino, mobile, poker, sweepstakes";
    ...
    $g_oCTLArcadeBaccarat =  new CTLArcadeBaccarat();
